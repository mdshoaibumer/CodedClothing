...
export const products = [
  ...
  /* ──── Jackets (Varsity & Outerwear) ──── */
  {
    ...
    color: COLORS.black.name, hex: COLORS.black.hex,
    ...img('jackets', 'black'),
    price: 899, label: 'Limited Edition',
